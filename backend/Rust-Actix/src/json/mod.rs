...
impl JsonService {
    ...
    pub fn to_json<T: Sized + serde::ser::Serialize>(&self, value: &T) -> serde_json::Result<String> {
        serde_json::to_string(value)
    }

    pub fn from_json<'a, T: serde::de::Deserialize<'a>>(&self, s: &'a str) -> serde_json::Result<T> {
...
mod test {
    ...
    fn should_serialize() {
        ...
        assert_eq!("{\"id\":123,\"colorName\":\"Red\"}".to_string(), json_string);
